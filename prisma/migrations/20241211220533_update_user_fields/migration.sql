...
INSERT INTO "new_User" ("createdAt", "email", "id", "isVerficationEmailSent", "name", "password", "username") SELECT "createdAt", "email", "id", "isVerficationEmailSent", "name", "password", "username" FROM "User";
DROP TABLE "User";
